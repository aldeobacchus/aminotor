        ...
        { trouve===1 && trouveIA===1 && (
            <div className="ariane__game">
                <div className="ariane__board">
                    <SelectionPanel mode="ariane" maskingMode={maskingMode} setMaskedImages={setMaskedImages} maskedImages={maskedImages} size={24} selectedImage={selectedImage} maskedList={maskedImages} squares={args.squares} squaresSources={args.squaresSources} onImageGuess={onImageGuess} />
                    <button className="ariane__button" onClick={handleMask}>{maskingMode ? "Mode normal" : "mode masque"}</button>
                    <button onClick={() => setTrouve(0)}>Auto win</button>
                </div>
                    ...
                    <>
                        ...
                        {question && (
                            <div className="theseus__questions">
                                ...
                                <button className='theseus__button-idk' onClick={() => handleAnswer(2)}>Je ne sais pas</button>
